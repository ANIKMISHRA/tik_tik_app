...
const VideoCard: NextPage<IProps> = ({ post }) => {
    ...
    /**
     * Method to handle the press on video
     */
    const onVideoPress = () => {
        if (playing) {
    ...
    <div className='flex flex-col border-b-2 border-gray-200 pb-6'>
        ...
        <div className='lg:ml-20 flex gap-4 relative'>
            ...
            className='rounded-3xl'>
                ...
                {isHover && (
                    <div className='absolute bottom-6 cursor-pointer left-8 md:left-14 lg:left-0 flex
                    gap-10 lg:justify-between w-[100pxf] md:w-[50px] p-3'>
                        {playing ? (
